...
export const navBarConfig: NavBarConfig = {
	links: [
		...
		// {
		// 	name: "My-Website",
		// 	url: "https://ase12345636.github.io/", // Internal links should not include the base path, as it is automatically added
...
export const profileConfig: ProfileConfig = {
	...
	name: "Terry",
	bio: "Computer Science, Japan, Research, Miscellany",
	links: [
		{
			name: "Facebook",
			...
			url: "https://www.facebook.com/ase12345636/",
		},
		{
			name: "Twitter",
			icon: "fa6-brands:twitter",
			url: "https://x.com/ase12345632",
		},
		{
			name: "Instagram",
			icon: "fa6-brands:instagram",
			url: "https://www.instagram.com/i_am_fat_fat_",
		},
		{
			name: "GitHub",
			icon: "fa6-brands:github",
			url: "https://github.com/ase12345636",
		},
	],
};
